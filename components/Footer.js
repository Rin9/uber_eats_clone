        ...
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="flex justify-center space-x-6">
            <a
              ...
              href="https://twitter.com/ThrillChilly"
              target="_blank"
          ...
          <nav className="relative flex flex-wrap justify-center gap-8 p-8 text-sm font-bold border-4 border-black rounded-xl">
            <a
              ...
              href="https://portfolio-rin9.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Portfolio
            ...
            <a
              className="hover:opacity-75"
              href="https://neat-blog.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Blog
          ...
          <p className="max-w-lg mx-auto text-xs text-gray-500">
            God only know what I will be without you.
          </p>

          <p className="text-xs font-medium">2022 Joseph Wang</p>
        </div>
      </div>
    </footer>
  );
